<div class="p-4 mt-16">
    ...
    <form wire:submit="updatePendaftaranEpt" class="w-full bg-white p-4 rounded my-2">
        <div class="mb-5">
            <label for="pendaftaran-ept" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Pendaftaran EPT</label>
...
<script>
    ...
    quill.root.innerHTML = '{!! $pendaftaranEpt !!}';
    quill.on('text-change', () => {@this.set('pendaftaranEpt', quill.getSemanticHTML())});
</script>
<div class="p-4 mt-16">
    ...
    <form wire:submit="updateJadwalKelas" class="w-full bg-white p-4 rounded my-2">
        <div class="mb-5">
            <label for="jadwal-kelas" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Jadwal Kelas</label>
...
<script>
    ...
    quill.root.innerHTML = '{!! $jadwalKelas !!}';
    quill.on('text-change', () => {@this.set('jadwalKelas', quill.getSemanticHTML())});
</script>
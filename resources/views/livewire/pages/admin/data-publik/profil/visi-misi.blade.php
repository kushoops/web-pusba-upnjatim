<div class="p-4 mt-16">
    ...
    <form wire:submit="updateVisiMisi" class="w-full bg-white p-4 rounded my-2">
        <div class="mb-5">
            <label for="visi-misi" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Visi Misi</label>
...
<script>
    ...
    quill.root.innerHTML = '{!! $visiMisi !!}';
    quill.on('text-change', () => {@this.set('visiMisi', quill.getSemanticHTML())});
</script>
<div class="p-4 mt-16">
    ...
    <form wire:submit="updatePelatihanBahasa" class="w-full bg-white p-4 rounded my-2">
        <div class="mb-5">
            <label for="tes-bahasa" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Pelatihan Bahasa</label>
...
<script>
    ...
    quill.root.innerHTML = '{!! $pelatihanBahasa !!}';
    quill.on('text-change', () => {@this.set('pelatihanBahasa', quill.getSemanticHTML())});
</script>